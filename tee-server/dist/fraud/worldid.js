...
exports.worldIdFraudCheck = void 0;
 ...
 */
const supabase = (0, supabase_js_1.createClient)(config_js_1.config.supabase.url, config_js_1.config.supabase.serviceRoleKey);
exports.worldIdFraudCheck = {
    async check(nullifierHash, _worldIdProof) {
        if (!nullifierHash) {
        ...
        if (data)
            throw new Error('User is banned from card issuance');
    },
    async ban(nullifierHash, reason) {
